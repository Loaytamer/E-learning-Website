...
// })
// let close_btn = document.getElementsByClassName("btn cancel")[0];
...
let view_all_btn = document.getElementById("view_all");
// view_all_btn.onclick(location.href='./courses.html')
for (let index = 0; index < 6; index++) {
  cards_container.childNodes[index].childNodes[4].addEventListener(
    "click",
    function () {
      course_index = index;
